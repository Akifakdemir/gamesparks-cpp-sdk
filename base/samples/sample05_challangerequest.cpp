...
void WithdrawChallengeRequest_Response(GS_& gsInstance, const WithdrawChallengeResponse& response)
{
	std::cout << "withdraw challnage: " << std::endl;
	std::cout << response.GetJSONString().c_str() << std::endl;
}

void GetChallengeRequest_Response(GS_& gsInstance, const GetChallengeResponse& response)
{
...
void CreateChallengeRequest_Response(GS_& gsInstance, const GameSparks::Api::Responses::CreateChallengeResponse& response)
{
...
void AuthenticationRequest_Response(GS_& gsInstance, const GameSparks::Api::Responses::AuthenticationResponse& response)
{
...
void OnAchievementEarnedMessage(GS_& gsInstance, const GameSparks::Api::Messages::AchievementEarnedMessage& message)
{
